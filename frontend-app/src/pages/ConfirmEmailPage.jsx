...
export default function ConfirmEmailPage() {
  ...
  async function handleSubmit(e) {
    ...
    setError('')
    try {
      const result = await confirmEmail(email, code.trim())
      // autoSignedIn: true means Amplify already signed the user in after confirmation.
      // Go straight to dashboard instead of making them log in again.
