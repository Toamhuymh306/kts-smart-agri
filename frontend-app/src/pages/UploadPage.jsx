...
export default function UploadPage() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      const { uploadUrl, imageId, contentType } = await getPresignedUrl(file.name, file.type)

      // Bước 2: PUT ảnh thẳng lên S3 — dùng contentType đã được sign
      await uploadToS3(uploadUrl, file, contentType, (pct) => setProgress(pct))
